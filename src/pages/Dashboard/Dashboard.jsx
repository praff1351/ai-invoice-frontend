...
const Dashboard = () => {
  ...
  return (
    <div className="flex flex-col space-y-8 min-h-screen pb-10">
      <div>
      ...
      <div className="mt-auto">
        <div className="w-full bg-white border border-slate-200 rounded-lg shadow-sm shadow-gray-100 overflow-hidden">
          <div
            className="px-4 sm:px-6 py-4 border-b border-slate-200 bg-slate-50 flex justify-between items-center
        "
          >
          ...
          {recentInvoices.length > 0 ? (
                ...
                <tbody className="bg-white divide-y divide-slate-200">
                  {recentInvoices.map((invoice) => (
                    ...
                    >
                      ...
                      <td className="px-6 py-4 whitespace-nowrap">
                        <span
                          className={`inline-flex items-center pc-2.5 py-0.5 rounded-full text-xs font-medium ${
                            invoice.status === "Paid"
            ...
            <div className="flex flex-col items-center justify-center py-12 text-center ">
              ...
              <p className="text-slate-500 mb--6 max-w-md pb-4">
                You have not created any invoices yet, Get started by creating
                your fist one.
              </p>
