...
const AllInvoices = () => {
  ...
  const handleDelete = async (id) => {
    ...
    try {
      ...
      const toDelete = invoices.filter(invoice => invoice._id !== id);
      setInvoices(toDelete);
    } catch (err) {
  ...
  const handleStatusChange = async (invoice) => {
    ...
    try {
      ...
      setInvoices((invoices)=>invoices.map((inv) => inv._id===invoice._id
        ? response.data: inv
      ));
    } catch (err) {
      ...
      <div className="bg-white border border-slate-200 rounded-lg shadow-sm">
          ...
          <div className="flex flex-col sm:flex-row gap-4">
            <div className="relative flex-grow">
              ...
              <input
                ...
                className="w-full  pl-18 pr-4 py-2 border border-slate-200 rounded-lg bg-white text-slate-900 placeholder-slate-400 focus:outline-none focus:ring-2 focus: ring-blue-500 "
                value={searchTerm}
        ...
        {filteredInvoices.length === 0 ? (
          <div className="flex flex-col items-center justify-center py-12 text-center">
            ...
            <p className="text-slate-500 mb-6 max-w-md">No results found.</p>
            {invoices.length === 0 && (
              <Button onClick={() => navigate("invoices/new")} icon={Plus}>
