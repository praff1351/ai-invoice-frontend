    ...
    <div className="relative">
      <button onClick={onToggle} className="flex items-center space-x-3 p-2 rounded-xl hover:bg-gray-50 transition-colors duration-200">
        ...
        <div className="hidden sm:block text-left">
          <p className="text-sm font-medium text-grau-900">{companyName}</p>
      ...
      {isOpen && (
        <div className=" absolute right-0 mt-2 w-56 bg-white rounded-xl shadow-lg border border-gray-100 py-2 z-50">
          ...
          <a onClick={() => navigate("/profile")} className="block px-4 py-2 text-sm text-gray-700 hover:bg-gray-500 transition-colors cursor-pointer">
            View Profile
          </a>
