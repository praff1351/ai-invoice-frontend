        ...
        <div className="bg-white rounded-lg shadow-xl max-w-lg w-full p-6 relative text-left transform transition-all">
          <div className="flex items-center justify-between mb-4">
            <h3 className="text-lg font-semibold text-slate-900 flex items-center">
              <Sparkles className="size-5 mr-2 text-blue-600"/>
              Create Invoice with AI
            </h3>
            <button onClick={onClose} className="text-slate-600 hover:text-slate-800">&times;
            </button>
          </div>
          <div className="space-y-4">
            <p className="text-sm text-slate-800">
              Paste any text that contains invoice details (like client name, items, quantites and prices) and the AI will attempt to create an 
              invoice from it.
            </p>
            <TextareaField 
