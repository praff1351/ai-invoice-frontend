  ...
  return (
    <header
      className={`fixed top-0 w-full z-50 transition-all  ${
        isScrolled ? "bg-white/95 backdrop-blur-sm shadow-lg" : "bg-white shadow-xl"
      }`}
    >
          ...
          <div className="hidden lg:flex items-center space-x-4">
            {isAuthenticated ? (
              ...
              <>
                ...
                <Link
                  to="/signup"
                  className="bg-gradient-to-r from-blue-950 to-blue-900 hover:bg-gray-800 text-white px-6 py-2.5 
          rounded-lg font-medium transition-all duration-200 hover:scale-105 hover:shadow-xl"
                >
                  Sign Up
                </Link>
              </>
